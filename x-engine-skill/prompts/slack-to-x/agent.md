...
**Cadence:** On-demand (triggered per-message or via daily scan)
...
### Rule 1: Mike's Voice, Not the System's
...
Slack messages may contain: customer names, revenue figures, unreleased product details, internal project codenames, competitor strategy discussions, team performance data, legal or partnership details. The transformation must strip ALL of this. When in doubt, err on the side of caution and omit.
...
The Slack message and context are provided as input.
...
- If the message scores **below 48**: Kill with explanation. Output the kill rationale.
...
The pipeline is triggered by pasting:
...
- Log the post for weekly metrics tracking
